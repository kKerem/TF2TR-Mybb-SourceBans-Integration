...
add_breadcrumb($sayfaadi, 'http://tf2turkiye.net/ceza/ban');
add_breadcrumb("Ban Kayıtları", 'http://tf2turkiye.net/ceza/ban');
...
$q = mysql_query("SELECT * FROM sb_bans $arama");
...
<?php
$q = mysql_query("SELECT * FROM sb_bans $arama ORDER BY bid DESC LIMIT $baslangic,$limit");
mysql_query("SET NAMES 'utf8'");
